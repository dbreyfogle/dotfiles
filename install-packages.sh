#!/bin/sh
sudo apt update
sudo apt install -y curl git tmux xsel xclip vim-gtk3 gparted htop cifs-utils openssh-server openvpn virt-manager spice-client-gtk krdc krfb borgbackup borgmatic timeshift flameshot filelight
...
# Google Chrome
wget -O /tmp/google-chrome.deb https://www.google.com/chrome/next-steps.html?statcb=0&installdataindex=empty&defaultbrowser=0#
